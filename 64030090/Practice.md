...
|  1.4 | First-name  |  ใช้ไม่ได้      |   มีตัวดำเนินการอยู่ในชื่อตัวแปร       
|  1.5 | Hello!      | ใช้ไม่ได้       |  มีตัวดำเนินการอยู่ในชื่อตัวแปร      
|  1.6 | w * h       | ใช้ไม่ได้       | ชื่อตัวแปรห้ามเว้นวรรค        
|  1.7 | time        |  ชื่อตัวแปรห้ามเว้นวรรค      |  ไม่มีตัวอักษรละเมิดกฎการตั้งชื่อ      
|  1.8 | do          | ใช้ไม่ได้       | do เป้นคำสั่งของ loop       
...
![image](https://user-images.githubusercontent.com/115066356/221416095-374528a5-aff9-456a-9d9b-29600c350e5b.png)
...
![image](https://user-images.githubusercontent.com/115066356/221416383-50301e35-1c12-4468-99bf-3f8af7a7463c.png)
...
```
![image](https://user-images.githubusercontent.com/115066356/221416521-b06f9f34-3b87-4ebd-bf70-84470ec8e684.png)
```
1.แสดงผลเลข 3 และ 5
...
```
![image](https://user-images.githubusercontent.com/115066356/221416612-5541f42f-39e9-4844-9811-574ae578e6b7.png)
```
...
```
![image](https://user-images.githubusercontent.com/115066356/221416677-fc514c68-6aa0-489a-b8f5-69fcb9e50c2c.png)
```
...
```
![image](https://user-images.githubusercontent.com/115066356/221416760-ed37869b-8b82-493a-af29-001aacdc462c.png)
```
...
```
![image](https://user-images.githubusercontent.com/115066356/221416838-e6ec4cea-96c8-4bb6-a979-836106a5cdef.png)
```
1.กำหนดค่าให้ตัวแปร i
2.แสดงข้อความ regular string format
...
```
![image](https://user-images.githubusercontent.com/115066356/221416947-28e77b6d-86d4-4293-89e0-69cda1e3f0a5.png)
```
...
```
![image](https://user-images.githubusercontent.com/115066356/221417112-625a57ff-26a2-4f92-8130-a177f694222c.png)
```
...
```
![image](https://user-images.githubusercontent.com/115066356/221417257-d5880bf7-780f-4774-8217-47e1d86912b6.png)
